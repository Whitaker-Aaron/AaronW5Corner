        ...
        <div style={{
            ...
            <div style={{ position: "relative", display: "flex", justifyContent: "space-between" }}>
                <div>
                    ...
                    <p style={{ overflowWrap: "break-word", opacity: 0.8, fontFamily: "Mark Pro", width: 200, maxHeight: 500, marginTop: 30, marginLeft: 72 }}>{props.description}</p>
                    {props.hasLink ?
            ...
            <div>
                <p style={{ marginLeft: 70, marginTop: toolsMargin, opacity: 0.8, fontFamily: "Mark Pro" }}> Tools used:</p>
            </div>
